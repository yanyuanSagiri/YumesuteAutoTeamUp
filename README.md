...
目前仍在绝赞开发中, 但是其他部分的时间开销还是太大了而且没优化, 适配了也没用, 所以暂时用不了. ~~而且还有点小问题, 是谁骗我计算逻辑写好了服务器 API 写好了只差配队逻辑了的~~
...
(实际上server那边角色/海报/饰品都套了网页版输入编队的 `partyManager` 的逻辑, 有点影响效率. **等待 [@Ohnkyta](https://github.com/OhnkytaBlabdey) 完善代码**)

(或者等人把全部东西都搬到本地就最好了, 因为主要问题还是计算器逻辑太复杂太慢)
